...
**Impact**: What changed (tables/columns/actions affected)
...
**Context**: New project started for [Client]
**Decision**: Created project folder from template
**Reason**: Standard OmmNoMi onboarding
**Impact**: All files created from `_Templates/`
